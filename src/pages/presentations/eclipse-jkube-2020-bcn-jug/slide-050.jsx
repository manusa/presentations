...
import micronautLogo from './assets/frameworks/micronaut-logo.svg';
    ...
    <ul className='what-is-jkube'>
      <li>
        ...
        <div className='framework-container'>
          ...
          <img className='item' src={micronautLogo} />
...
export default slideControls(Slide050, '/presentations/eclipse-jkube-2020-bcn-jug/slide-040', '/presentations/eclipse-jkube-2020-bcn-jug/slide-060');
