...
const Slide130 = () => (
  <TitleTemplate className='eclipse-jkube-2020-bcn-jug-thank-you'>
...
export default slideControls(Slide130, '/presentations/eclipse-jkube-2020-bcn-jug/slide-120', '/presentations/eclipse-jkube-2020-bcn-jug');
