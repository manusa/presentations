...
const Slide040 = ({currentStep}) => {
  ...
  return (
    <SlideTemplate slide={4} title='Introduction'>
...
export default slideControls(Slide040, '/presentations/2022-kubernetes-for-java-developers/slide-030',
  '/presentations/2022-kubernetes-for-java-developers/slide-050', 3);
