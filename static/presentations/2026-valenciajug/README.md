...
This deck is a **fork of the DevTalks Romania 2026 deck** (originally generated by Claude Design, then cleaned up). It was copied to this slug and re-themed for Valencia JUG: near-black base + warm radial glow + vermilion-orange accent (sampled from the meetup flyer), replacing Romania's navy + pink + purple. Same Inter + JetBrains Mono type, same terminal motifs, same talk content.
